                ...
                function wpTwickitLinkInit(inId, inBubble) {
                    TwickitAutolink.observe(
                        ...
                        function(inEvent) {
                            ...
                            TwickitBubble.open(tempX, tempY, "twickit", "<?php echo($options["color"]) ?>");
			...
			<div class="wrap">
				...
				<form action="" method="post" id="twickitlinks-conf">
					...
					<table class="form-table">
						...
						<tr>
							<td>
								<label for="twickitlinkstarget"><?php echo __('Color', 'twickit') ?>:</label>
							</td>
							<td>
								#<input size="10" type="text" id="twickitlinkscolor" name="twickitlinkscolor" value="<?php echo $options['color'];?>"/>
							</td>
						</tr>
						<tr>
							<td>
