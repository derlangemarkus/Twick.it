			...
			?>
				...
				<div class="blog-kasten">
					...
					<div class="blog-body">
						...
						<iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo urlencode(get_permalink($post->ID)); ?>&amp;show_faces=false&amp;width=500&amp;font=arial" scrolling="no" frameborder="0" style="border:none; overflow:hidden;display:block;width:500px;padding-top:20px;height:30px;" allowTransparency="true"></iframe>
					</div>
					<div class="blog-footer">
						<br /><span><?php loc('blog.created', get_the_time(__('d.m.Y', 'kubrick'))) ?></span> | 
						<?php comments_popup_link(__('Kommentare (0)'), __('Kommentare (1)'), __('Kommentare (%)', "pfeil-link")); ?>
