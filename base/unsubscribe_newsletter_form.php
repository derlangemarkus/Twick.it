					...
					<div class="sprechblase-main">
				        ...
				        <div class="sprechblase-rechts">
				        	<div class="blase-header" id="eingabeblase-head">
				            	<div class="kurzerklaerung"><span><?php loc('unsubscribeNewsletter.subline') ?></span></div>
				            </div>
				            <div class="blase-body">
								<div class="twick-link">
									<?php loc('unsubscribeNewsletter.text') ?><br />
									<br />
									<a href="unsubscribe_newsletter.php?id=<?php echo($id) ?>&secret=<?php echo(getArrayElement($_GET, "secret")) ?>"><?php loc('unsubscribeNewsletter.yes') ?></a><br />
									<br />
								</div>
				            </div>
