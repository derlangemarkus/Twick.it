...
<head>
	...
	<style type="text/css">
		...
		.infobox_gross a {display:block;float:left;font-size:22px; color:#709700;padding:14px 55px 14px 130px;background-image:url(siegen/img/btn_weiter_kl.jpg);background-repeat:no-repeat;background-position:260px 3px;}
			...
			<div class="inhalte-links" style="width:920px;height:245px;background-image:url(siegen/img/bg_verlauf.jpg);background-repeat: repeat-x;">
				...
				<div id="registernow" class="infobox" style="width:350px;">
					...
					<div class="infobox_gross">
						<span>Am NRW-Tag vom 17.-19.09. werden ca. 300.000 Besucher in Siegen erwartet. Zeige den Gästen deine Stadt und erkläre Begriffe rund um Siegen in max. 140 Zeichen. Als Gewinn winken exklusive VIP-Tickets.<br />
						<a href="http://twick.it/blog/de/agb/teilnahmebedingungen-siegener-erklaerwettbewerb/" style="background-image:none;font-size:12px;width:250px;padding:5px 0px 0px 0px;" target="_blank">Zu den Teilnahmebedingungen</a></span>
					</div>
					<?php } else { ?>
					<h1 style="padding-left:7px;">Jetzt registrieren &amp; mitmachen:</h1>
					<div class="infobox_gross">
						<span>Wie im Video erklärt, musst Du Dich registrieren, um mitzumachen. Keine Angst, 
						es dauert nicht lange und tut auch gar nicht weh.</span><br />
						<a href="register_form.php">Registrieren</a><br />
						<a href="http://twick.it/blog/de/agb/teilnahmebedingungen-siegener-erklaerwettbewerb/" style="background-image:none;font-size:12px;width:250px;padding:0px;" target="_blank">Zu den Teilnahmebedingungen</a>
					</div>
					<?php } ?>
				</div>
			</div>
		...
		<div class="content">
			...
			<div class="inhalte-links" style="width:920px;background-color:#EFEFEF;padding-top:10px;">
				<div id="film1" style="background-color:#000;width:640px;padding:8px;position:absolute;margin-top:-570px;margin-left:120px;z-index:9999;display:none;">
					...
					<object width="640" height="505"><param name="movie" value="http://www.youtube.com/v/AlQWxRYNXOQ&hl=de_DE&fs=1&color1=0x3a3a3a&color2=0x999999"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/AlQWxRYNXOQ&hl=de_DE&fs=1&color1=0x3a3a3a&color2=0x999999" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="640" height="505"></embed></object>
				</div>
