...
$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/../../../writable/cache';                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_maxsize'] = 30 * 1024 * 1024; // delete least-recently-accessed cached thumbnails when more than [30MB] of cached files are present (value is maximum bytesize of all cached files)

//$PHPTHUMB_CONFIG['cache_maxfiles'] = null;          // never delete cached thumbnails based on number of cached files
$PHPTHUMB_CONFIG['cache_maxfiles'] = 600;             // delete least-recently-accessed cached thumbnails when more than [600] cached files are present (value is maximum number of cached files to keep)
...
$PHPTHUMB_CONFIG['cache_source_directory'] = $PHPTHUMB_CONFIG['cache_directory'];
