...
function confirmPopup(inText, inLink) {
	...
	$("popup-footer").innerHTML += '<div><a href="' + inLink + '" id="popup_yes" class="teaser-link"><?php loc('core.yes') ?></a><a href="javascript:;" onclick="$(\'curtain\').remove(); $(\'popup-kasten\').remove();" id="popup_no"><?php loc('core.no') ?></a></div>';
}
...
function preloadButtonImages() {
	...
	preloadImage("<?php echo(HTTP_ROOT)?>/lang/<?php echo($language) ?>/buttons/bt_podcast_hover.png");
	...
	preloadImage("<?php echo(HTTP_ROOT)?>/html/img/ajax-loader.gif");
	preloadImage("<?php echo(STATIC_ROOT)?>/html/img/stift_hover.gif");
