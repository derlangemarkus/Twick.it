...
<head>
    ...
    <title><?php loc('unknownUser.title') ?> | <?php loc('core.titleClaim') ?></title>
	<meta property="og:title" content="<?php loc('unknownUser.title') ?>" />
    <meta name="description" content="<?php loc('unknownUser.title') ?> | <?php loc('core.titleClaim') ?>" />   
...
<body>
    ...
    <div id="contentFrame">
		...
		<div class="header-ergebnisfeld" id="header-ergebnisfeld">
			<h1><?php loc('unknownUser.headline') ?></h1>
		</div>
		...
		<div class="content">
					...
					<div class="sprechblase-main">
				        ...
				        <div class="sprechblase-rechts">
				        	<div class="blase-header" id="eingabeblase-head">
				            	<div class="kurzerklaerung"><span><?php loc('unknownUser.sorry', array($userName, $login))?></span></div>
				            </div>
				            <div class="blase-body">
								<div class="twick-link">
									<?php loc('unknownUser.text')?>
								</div>
				            </div>
			...
			<div class="inhalte-rechts">
				...
				<!-- Info | START -->
			    <div class="teaser">
			    	<div class="teaser-head"><h2><?php loc('unknownUser.marginal.oups.title') ?></h2></div>
			        <div class="teaser-body">
			        	<div>
			        		<?php loc('unknownUser.marginal.oups.text1') ?><br />
			        		<br />
			        		<?php loc('unknownUser.marginal.oups.text2', '<b><a href="mailto:' . encodeEMailAddress(SUPPORT_MAIL_RECEIVER) . '">' . encodeEMailAddress(SUPPORT_MAIL_RECEIVER) . '</a></b>') ?>
			            </div>
			        </div>
