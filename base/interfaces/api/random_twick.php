...
$username = strtolower(getArrayElement($_GET, "username", false));
$best = strtolower(getArrayElement($_GET, "best", false));
...
if ($best && !$username) {
	...
	foreach($topics as $topic) {
		$twicks[] = $topic->findBestTwick();
	}
} else {
	$twicks = Twick::fetchRandom($limit, $username);
}
