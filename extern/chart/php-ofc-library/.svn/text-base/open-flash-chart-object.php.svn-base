...
function _ofc( $width, $height, $url, $use_swfobject, $base )
{
    ...
    $out[] = '<param name="movie" value="'. $base .'open-flash-chart.swf?data-file='. $url .'" />';
    $out[] = '<param name="quality" value="high" />';
    $out[] = '<param name="bgcolor" value="#FFFFFF" />';
    $out[] = '<embed src="'. $base .'open-flash-chart.swf?data-file=' . $url .'" quality="high" bgcolor="#FFFFFF" width="'. $width .'" height="'. $height .'" name="'. $obj_id .'" align="middle" allowScriptAccess="sameDomain" ';
